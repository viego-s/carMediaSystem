...
"#label_map{image: url(:/image/map.svg);}"));
        ...
        musicIconButton = new QPushButton(centralwidget);
        musicIconButton->setObjectName(QString::fromUtf8("musicIconButton"));
        musicIconButton->setGeometry(QRect(350, 350, 111, 101));
        musicIconButton->setStyleSheet(QString::fromUtf8("border-image: url(:/image/image/title/wangyiMusic.png);"));
